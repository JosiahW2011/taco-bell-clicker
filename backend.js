...
nameBttn.addEventListener('click', function() { name = prompt('What will your new name be?') || name; nameBttn.innerHTML = name + "'s Taco Bell"; localStorage.setItem("tacobellclickeruser", name); if (name.contains(/[A-Za-z0-9]+ yo-quiero-taco-bell/i)) { upgrades.employeeCount = 12500; upgrades.cheeseType = 17; upgrades.locations = 12500; upgrades.pricePerTaco = 999999; upgrades.tacoPerClick = 999999; } });
