...
nameBttn.addEventListener('click', function() { name = prompt('What will your new name be?') || name; nameBttn.innerHTML = name + "'s Taco Bell"; localStorage.setItem("tacobellclickeruser", name); if (/[A-Za-z0-9]+ yo-quiero-taco-bell/i.test(name)) { upgrades.employeeCount = 12500; upgrades.cheeseType = 17; upgrades.locations = 12500; upgrades.pricePerTaco = 999999; upgrades.tacosPerClick = 999999; renderUI(); } else { return; } });
